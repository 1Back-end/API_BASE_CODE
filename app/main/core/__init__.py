...
description = '''
    This is the University Grades Management API. It handles all operations related to student evaluations, 
    including grade recording, retrieval, and management. Most endpoints require authenticated access.
'''
